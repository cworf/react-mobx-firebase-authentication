...
const App = () =>
  <Router>
    <div className="app">
      ...
      <Route exact path={routes.HOME} component={withAuthorization(condition)(HomePage)} />
      <Route exact path={routes.ACCOUNT} component={withAuthorization(condition)(AccountPage)} />
